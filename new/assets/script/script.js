			...
			$this.on('click', function(e){
				...
				$.ajax({
					...
					success: function(data) {
						...
						var $popup = $(data).appendTo($body);
						
						if ($popup.hasClass('popup-gallery')){
							
							$popup.find('.popup-slideshow ul').carouFredSel({
								auto:10000,
								items: {
									visible:1,
									height: 'variable'
								...
								responsive: true,
								height: 'variable',
								prev: '.popup-slideshow .prev-image',
								next: '.popup-slideshow .next-image'
							})		
						} 
